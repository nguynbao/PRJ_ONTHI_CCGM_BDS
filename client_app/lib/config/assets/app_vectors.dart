class AppVector {
  ...
  static const String base = 'assets/vector/';
  static const String iconHome = '${base}icon_home$format';
  static const String iconCourses = '${base}icon_courses$format';
  static const String iconExam = '${base}icon_exam$format';
  static const String iconNoti = '${base}icon_noti$format';
  ...
  static const String iconEssay = '${base}icon_essay$format';
}
